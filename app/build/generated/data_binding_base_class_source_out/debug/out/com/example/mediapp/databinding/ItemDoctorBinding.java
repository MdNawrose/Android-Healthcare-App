...
public final class ItemDoctorBinding implements ViewBinding {
  ...
  private ItemDoctorBinding(@NonNull CardView rootView, @NonNull TextView doctorDistance,
      @NonNull ImageView doctorImage, @NonNull TextView doctorName, @NonNull TextView doctorRating,
  ...
  public static ItemDoctorBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemDoctorBinding((CardView) rootView, doctorDistance, doctorImage, doctorName,
          doctorRating, doctorSpecialty);
    }
